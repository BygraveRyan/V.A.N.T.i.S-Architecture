...
Any plan generated using this skill (including those in `plan_mode` or temporary research) MUST be mirrored/persisted into `vault/05_TASKS/` upon approval. This ensures:
