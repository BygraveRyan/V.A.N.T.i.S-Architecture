...
- **Output** (`06_OUTPUT/`): AI-generated synthesis (mandatory staging).
    - Concept Candidates -> `vault/06_OUTPUT/Concept_Candidates/`
    - Reddit Syntheses -> `vault/06_OUTPUT/Reddit_Syntheses/`
    - LinkedIn Drafts -> `vault/06_OUTPUT/LinkedIn_Drafts/`
    - Session Reviews -> `vault/06_OUTPUT/AI-Daily-Review/`
...
# Routing Rules
• **AI Staging**: AI-generated content MUST go to `06_OUTPUT` first for human review.
