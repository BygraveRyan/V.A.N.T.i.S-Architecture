...
• Reviewing `06_MACHINE` or `01_INBOX` for reusable conceptual knowledge.
...
Create a `concept-candidate-*` file in `06_MACHINE`.
...
# Output Rules
All proposals and candidates MUST be stored in `06_MACHINE` for human verification.
