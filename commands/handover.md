...
5. Invoke the shared `audit-logger` Tier 2 process if the reasoning context is non-obvious from the diff alone.
6. State "HANDOVER COMPLETE" once the addendum is persisted.
