...
| Field | Source |
| --- | --- |
| Title | Operator-provided, or Claude-derived |
| Category | Operator-provided, required |
| Evidence / Trigger | Operator-provided from the freeform idea |
| Audience | Claude-derived |
| Platform | Claude-derived, single platform only |
| Format | Claude-derived |
| Job | Claude-derived |
| Angle | Claude-derived |
| Problem Addressed | Claude-derived |
| Source Reference | Deferred, leave blank unless provided |
| Priority | Claude-derived, default `Medium` unless urgency is clear |
