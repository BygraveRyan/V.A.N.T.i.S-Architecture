...
1. **NO GALAXY WRITES:** Agents are strictly prohibited from writing or moving files into `02_KNOWLEDGE/Galaxy`. All synthesis must land in `06_OUTPUT` for human verification.
