...
• `[REDACTED_PERSONAL_VAULT]/Projects/` — project state  
• `[REDACTED_PERSONAL_VAULT]/Tasks/` — tasks  
...
• `[REDACTED_PERSONAL_VAULT]/Personal/` — private data  
• `[REDACTED_PERSONAL_VAULT]/Knowledge/Galaxy/` — human knowledge (local-first)  
• `.env` — secrets  
