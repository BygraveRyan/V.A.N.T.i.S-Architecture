...
## Constraints
- **NO GALAXY WRITES**: The Architect must never modify files in `[REDACTED_PERSONAL_VAULT]/Knowledge/Galaxy`.
...
- **Restricted**: Web search, `[REDACTED_PERSONAL_VAULT]/Knowledge/`, `[REDACTED_PERSONAL_VAULT]/Projects/` (writes).
