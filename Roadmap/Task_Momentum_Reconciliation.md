...
- **n8n Crystallization**: Generate and save the actual client project AI workflow JSON.
...
- [ ] **n8n Export**: Extract the live client project workflow to `private workspace/Business/client-work/`.
- [ ] **Business Architect Sift**: Use the new role to filter the 31 candidates for high-ROI business concepts.
- [ ] **Galaxy Promotion**: Move verified concepts to `private workspace/Knowledge/Galaxy/`.
