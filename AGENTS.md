...
Universal Adapter providing provider redundancy and cross-model validation.

Capabilities:

• GPT-4o / o1 model access
• High-fidelity code generation
• Native vault integration
• Universal command parity

Mandates:

• MUST follow CODEX.md
• MUST execute the Global Agent Mandates (Logging, ASV, Plan Mode).

Activated When:

• Claude/Gemini weekly limits are reached
• GPT-specific insights are needed
• Cross-model validation requested
