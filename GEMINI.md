...
- **AI-Generated Synthesis:** 06_OUTPUT (**Mandatory Staging**)
- **Unprocessed/Raw Notes:** 01_INBOX (Archived to `/Archive` after processing)

AI synthesis *must* land in 06_OUTPUT for human verification before it can be manually promoted to the Galaxy.
